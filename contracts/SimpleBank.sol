...
contract SimpleBank {
    ...
    // Add an argument for this event, an accountAddress V
    event LogEnrolled(address accountAddress);

    // Add 2 arguments for this event, an accountAddress and an amount V
    event LogDepositMade(address accountAddress, uint256 amount);

    // Create an event called LogWithdrawal
    // Hint: it should take 3 arguments: an accountAddress, withdrawAmount and a newBalance V
    event LogWithdrawal(
    ...
    function deposit() public payable returns (uint256) {
        ...
        require(enrolled[msg.sender] = true, "User has not been enorolled");
